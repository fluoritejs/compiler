...
/**
 * The entry module reads `id`, `name`, and the icon from `${runtimeGlobal}`.
 */
...
/**
 * Exports a used function and an `unusedFunction` so tree-shaking is observable.
 */
...
/**
 * Writes missing scaffold files; existing files are skipped.
 */
